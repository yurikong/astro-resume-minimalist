...
export const GET: APIRoute = () => {
  const projectList: IProject[] = [
    ...
    },
    {
      ...
      technologiesUsed: ["Vue 2", "Vuex", "Vue Router", "Javascript", "Echarts", "G2", "G2Plot", "Swiper", "Webpack"],
      startYear: 2022,
      endYear: 2023,
    },
    {
      ...
      technologiesUsed: ["Vue 2", "Vuex", "Vue Router", "Javascript", "Element UI", "Webpack"],
      startYear: 2022,
      endYear: 2023,
    },
    {
      ...
      technologiesUsed: ["Vue 2", "Vuex", "Vue Router", "Javascript", "ECharts", "G2", "G2Plot", "Webpack"],
      startYear: 2022,
      endYear: 2022,
    },
    {
      ...
      technologiesUsed: ["Vue 2", "Javascript", "G2Plot", "Webpack"],
      startYear: 2022,
      endYear: 2022,
    },
    {
